...
RUN ["/bin/bash", "-c", "echo \"export PYENV_ROOT=\"$HOME/.pyenv\"\" >> /root/.bash_profile"]
RUN ["/bin/bash", "-c", "echo \"export PATH=\"$PYENV_ROOT/shims:$PYENV_ROOT/bin:$PATH\"\" >> /root/.bash_profile"]
